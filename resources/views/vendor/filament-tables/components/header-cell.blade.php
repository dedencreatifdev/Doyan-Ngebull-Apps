...
>
    ...
    >
        <span
            class="fi-ta-header-cell-label text-sm font-semibold text-gray-950 dark:text-white text-white "
        >
            {{ $slot }}
        </span>
        ...
        @if ($sortable)
            <x-filament::icon
                ...
                @class([
                    'fi-ta-header-cell-sort-icon h-5 w-5 shrink-0 transition duration-75 text-white',
