...
>
    <div>
        ...
        <h1
            class="fi-header-heading text-xl font-bold tracking-tight text-gray-950 dark:text-white sm:text-2xl"
        >
            {{ $heading }}
        </h1>
        ...
        @if ($subheading)
            <p
                class="fi-header-subheading mt-2 max-w-2xl text-md text-gray-600 dark:text-gray-400"
            >
                {{ $subheading }}
            </p>
        @endif
