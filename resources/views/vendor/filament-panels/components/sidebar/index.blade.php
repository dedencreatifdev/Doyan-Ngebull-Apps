...
>
        ...
        >
            ...
            @if (filament()->isSidebarCollapsibleOnDesktop())
                <x-filament::icon-button
                    color="gray"
                    :icon="$isRtl ? 'heroicon-o-bars-3' : 'heroicon-o-bars-3'"
    ...
    <nav
        class="fi-sidebar-nav flex-grow flex flex-col gap-y-7 overflow-y-auto overflow-x-hidden px-6 py-8 shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10"
